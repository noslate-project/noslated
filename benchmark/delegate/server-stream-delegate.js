...
const bench = common.createBenchmark(createDelegate(__filename, {
  getInput: () => {
    return fs.createReadStream(path.resolve(__dirname, '../../fixtures/lorum.txt'), 'utf8');
  },
}, ({ c, duration, method }, onEnd) => {
  bench.http({
    path: `/${method}`,
    connections: c,
    duration,
